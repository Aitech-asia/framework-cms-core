...
use Core\User\Http\Requests\TeamRequest;
use Core\User\Interfaces\TeamRepositoryInterface;
use Core\User\Models\Team;
...
class TeamAPIController extends BaseController
{
    ...
    public function __construct(TeamRepositoryInterface $team)
    {
        ...
        $this->repository
            ...
            ->pushCriteria(\Core\User\Repositories\Criteria\TeamResourceCriteria::class);
    }
    ...
    public function index(TeamRequest $request)
    {
        return $this->repository
            ->setPresenter(\Core\User\Repositories\Presenter\TeamListPresenter::class)
            ->paginate();
    }
    ...
    {
        return $team->setPresenter(\Core\User\Repositories\Presenter\TeamListPresenter::class);
