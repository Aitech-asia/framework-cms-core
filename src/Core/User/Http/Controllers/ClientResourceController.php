...
use Core\User\Http\Requests\ClientRequest;
use Core\User\Interfaces\ClientRepositoryInterface;
use Core\User\Models\Client;
/**
...
class ClientResourceController extends BaseController
{
    ...
    public function __construct(ClientRepositoryInterface $client, $type = null)
    {
        ...
        $this->repository
            ...
            ->pushCriteria(\Core\User\Repositories\Criteria\ClientResourceCriteria::class);
    }
    ...
    public function index(ClientRequest $request, String $type)
    {
        ...
        if ($this->response->typeIs('json')) {
            ...
            return $this->repository
                ->setPresenter(\Core\User\Repositories\Presenter\ClientPresenter::class)
                ->$function();
        }
