...
class User
{
     ...
     *  Initialize User.
     *
     * @param \Core\Contracts\User\User                 $user
     * @param \Core\Contracts\User\Role                 $role
     * @param \Core\Contracts\User\PermissionRepository $permission
     */
     ...
     * @param bool  $activate
     *
     * @return \Core\Contracts\User\User
     */
    ...
    /**
     * Returns the current user being used by Core, if any.
     *
