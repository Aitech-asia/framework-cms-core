...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'Core\User\Http\Controllers';
    ...
    public function boot()
    {
        ...
        if (Request::is('*admin/user/user/*')) {
            Route::bind('user', function ($user) {
                $repos = $this->app->make('Core\User\Interfaces\UserRepositoryInterface');
        ...
        if (Request::is('*/user/team/*')) {
            Route::bind('team', function ($team) {
                $teamrepo = $this->app->make('Core\User\Interfaces\TeamRepositoryInterface');
        ...
        if (Request::is('*admin/user/*')) {
            Route::bind('client', function ($client) {
                $repos = $this->app->make('Core\User\Interfaces\ClientRepositoryInterface');
