...
namespace Core\Roles\Http\Controllers;

use App\Http\Controllers\ResourceController as BaseController;
use Core\Roles\Http\Requests\PermissionRequest;
...
class PermissionResourceController extends BaseController
{
    ...
    public function __construct(PermissionRepositoryInterface $permission)
    {
        ...
        $this->repository
            ...
            ->pushCriteria(\Core\Roles\Repositories\Criteria\PermissionResourceCriteria::class);
    }
    ...
    public function index(PermissionRequest $request)
    {
        if ($this->response->typeIs('json')) {
            ...
            $data = $this->repository
                ->setPresenter(\Core\Roles\Repositories\Presenter\PermissionListPresenter::class)
