...
use Core\Roles\Http\Requests\RoleRequest;
...
class RoleResourceController extends BaseController
{
    ...
    public function __construct(
        ...
        $this->repository
            ...
            ->pushCriteria(\Core\Roles\Repositories\Criteria\RoleResourceCriteria::class);
    }
    ...
    public function index(RoleRequest $request)
    {
        if ($this->response->typeIs('json')) {
            ...
            $data = $this->repository
                ->setPresenter(\Core\Roles\Repositories\Presenter\RoleListPresenter::class)
