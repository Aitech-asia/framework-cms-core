...
class RolesServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('roles.roles', function ($app) {
            return $this->app->make('Core\Roles\Roles');
        });

        // Bind Role to repository
        $this->app->bind(
            'Core\Roles\Interfaces\RoleRepositoryInterface',
            \Core\Roles\Repositories\Eloquent\RoleRepository::class
        );
        // Bind Permission to repository
        $this->app->bind(
            'Core\Roles\Interfaces\PermissionRepositoryInterface',
            \Core\Roles\Repositories\Eloquent\PermissionRepository::class
        );

        $this->registerBladeExtensions();
        $this->app->register(\Core\Roles\Providers\AuthServiceProvider::class);
        $this->app->register(\Core\Roles\Providers\RouteServiceProvider::class);
    }
