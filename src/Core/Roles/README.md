...
Powerful package for handling roles and permissions in laravelcms.
...
Publish the package config file and migrations to your application. Run these commands inside your terminal.
    ...
    php artisan vendor:publish --provider="Core\Roles\RolesServiceProvider" --tag=config
    php artisan vendor:publish --provider="Core\Roles\RolesServiceProvider" --tag=migrations
...
use Core\Roles\Interfaces\HasRoleAndPermission as HasRoleAndPermissionContract;
...
```php
use Core\Roles\Models\Permission;
...
protected $routeMiddleware = [
    ...
    'role' => \Core\Roles\Middleware\VerifyRole::class,
    'permission' => \Core\Roles\Middleware\VerifyPermission::class,
    'level' => \Core\Roles\Middleware\VerifyLevel::class,
];
```
...
It throws `\Core\Roles\Exceptions\RoleDeniedException`, `\Core\Roles\Exceptions\PermissionDeniedException` or `\Core\Roles\Exceptions\LevelDeniedException` exceptions if it goes wrong.
...
{
    if ($e instanceof \Core\Roles\Exceptions\RoleDeniedException) {
...
For more information, please have a look at [HasRoleAndPermission](https://github.com/romanCore/roles/blob/master/src/Core/Roles/Contracts/HasRoleAndPermission.php) contract.
