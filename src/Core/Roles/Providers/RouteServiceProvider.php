...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'Core\Roles\Http\Controllers';
    ...
    public function boot()
    {
        ...
        if (Request::is('*/roles/role/*')) {
            Route::bind('role', function ($role) {
                $rolerepo = $this->app->make('Core\Roles\Interfaces\RoleRepositoryInterface');
        ...
        if (Request::is('*/roles/permission/*')) {
            Route::bind('permission', function ($permission) {
                $permissionrepo = $this->app->make('Core\Roles\Interfaces\PermissionRepositoryInterface');
