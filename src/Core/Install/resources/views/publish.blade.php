                        ...
                        <div class="wizard-container">
                            <div class="wizard-card" id="wizard">
                                <div class="wizard-header">
                                    ...
                                    <p class="category">laravel Installation Wizard</p>
                                </div>
                                ...
                                <div class="tab-content">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <h5 class="info-text">Publish config, assets, public files, language files, default theme, migratins and seeds for laravel and Core packages.</h5>
                                        </div>
