...
class PageTableSeeder extends Seeder
{
    public function run()
    {
        DB::table(config('Core.page.page.table'))->insert([
            ...
            [
                ...
                'meta_description' => 'This is a started theme for laravel cms, you can customize according to your requirement.',
                'images'           => null,
                'abstract'         => null,
                'order'            => 0,
                'banner'           => null,
