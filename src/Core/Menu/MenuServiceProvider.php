...
class MenuServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('menu', function ($app) {
            return $this->app->make('Core\Menu\Menu');
        });

        // Bind Menu to repository
        $this->app->bind(
            'Core\Menu\Interfaces\MenuRepositoryInterface',
            \Core\Menu\Repositories\Eloquent\MenuRepository::class
        );

        $this->app->register(\Core\Menu\Providers\AuthServiceProvider::class);
        $this->app->register(\Core\Menu\Providers\RouteServiceProvider::class);
    }
