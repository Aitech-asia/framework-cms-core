...
class Theme
{
     ...
     * @param \Core\Theme\asset                           $asset
     * @param \Illuminate\Filesystem\Filesystem              $files
     * @param \Teepluss\Breadcrumb|\Core\Theme\Breadcrumb $breadcrumb
     *
