...
'providers' => [
    ...
    'Core\Theme\ThemeServiceProvider',
...
'aliases' => [
    ...
    'Theme' => 'Core\Theme\Facades\Theme',
...
~~~
php artisan vendor:publish --provider="Core\Theme\ThemeServiceProvider"
~~~
...
### Using theme global
~~~php
use Core\Theme\Contracts\Theme;
