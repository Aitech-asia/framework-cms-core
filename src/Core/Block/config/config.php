...
return [
    ...
    'category' => [
        'model'         => 'Core\Block\Models\Category',
        'table'         => 'block_categories',
        'presenter'     => \Core\Block\Repositories\Presenter\CategoryItemPresenter::class,
        'hidden'        => [],
        'visible'       => [],
        'guarded'       => ['*'],
        'slugs'         => ['slug' => 'name'],
    ...
    'block'    => [
        'model'         => 'Core\Block\Models\Block',
        'table'         => 'blocks',
        'presenter'     => \Core\Block\Repositories\Presenter\BlockItemPresenter::class,
        'hidden'        => [],
        'visible'       => [],
        'guarded'       => ['*'],
        'slugs'         => ['slug' => 'name'],
