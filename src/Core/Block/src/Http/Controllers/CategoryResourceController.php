...
namespace Core\Block\Http\Controllers;

use App\Http\Controllers\ResourceController as BaseController;
use Core\Block\Http\Requests\CategoryRequest;
use Core\Block\Interfaces\CategoryRepositoryInterface;
use Core\Block\Models\Category;
...
class CategoryResourceController extends BaseController
{
    ...
    public function __construct(CategoryRepositoryInterface $category)
    {
        ...
        $this->repository
            ...
            ->pushCriteria(\Core\Block\Repositories\Criteria\CategoryResourceCriteria::class);
    }
    ...
    public function index(CategoryRequest $request)
    {
        ...
        if ($this->response->typeIs('json')) {
            ...
            $data      = $this->repository
                ->setPresenter(\Core\Block\Repositories\Presenter\CategoryListPresenter::class)
