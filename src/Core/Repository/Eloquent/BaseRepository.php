...
use Core\Repository\Contracts\Presentable;
use Core\Repository\Contracts\PresenterInterface;
use Core\Repository\Contracts\RepositoryCriteriaInterface;
use Core\Repository\Contracts\RepositoryInterface;
use Core\Repository\Events\RepositoryEntityCreated;
use Core\Repository\Events\RepositoryEntityDeleted;
use Core\Repository\Events\RepositoryEntityUpdated;
...
abstract class BaseRepository implements RepositoryInterface, RepositoryCriteriaInterface
{
    ...
    public function pushCriteria($criteria)
    {
        ...
        if (!$criteria instanceof CriteriaInterface) {
            throw new RepositoryException('Class '.get_class($criteria).' must be an instance of Core\\Repository\\Contracts\\CriteriaInterface');
        }
